...
self.TrackJS = self.trackJs = (function(g, l, n) {
    ...
    q.prototype = {
        ...
        serialize: function(a) {
          ...
          try {
            d = JSON.stringify(a, function(a, d) {
              return d === n ? "undefined" : c.isNumber(d) && isNaN(d) ? "NaN" : c.isError(d) ? {
                name: d.name,
                message: d.message,
                stack: d.stack
              } : c.isElement(d) ? b(d) : d
          ...
          if (a.hasOwnProperty(c))
            if (b.hasOwnProperty(c)) {
              ...
              g !== typeof a[c] ? (console.warn(d + "." + c + ": property must be type " + g + "."),
                f = !1) : "[object Array]" !== Object.prototype.toString.call(a[c]) || this.validateArray(a[c], b[c], d + "." + c) ? "[object Object]" === Object.prototype.toString.call(a[c]) ? f = this.validate(a[c], b[c], d + "." + c, e[c]) : e.hasOwnProperty(c) && (console.warn(d + "." + c + ": property cannot be set after load."),
                f = !1) : f = !1
            } else
      ...
      validateArray: function(a, b, d) {
        ...
        for (var f = 0; f < a.length; f++)
          c.contains(b, a[f]) || (console.warn(d + "[" + f + "]: invalid value: " + a[f] + "."),
            e = !1);
        return e
      }
    };
          ...
          return function(h, p) {
            ...
            return l.then(function(a) {
              ...
              if (f) {
                ...
                d.error && 400 <= a.status && (f = Error(f.statusCode + " : " + f.method + " " + f.url),
                  f.stack = k,
                  e("ajax", f))
              }
              return a
              ...
              d.error && (e("ajax", {
                name: a.name,
                message: (a.message || "Failed") + ": " + f.method + " " + f.url,
                stack: a.stack || k
              }),
    ...
    t.prototype = {
      ...
      sendTrackerFault: function(a) {
        this.throttle(a) || (c.isBrowser ? l.createElement("img").src = this.trackerFaultEndpoint(a) : fetch(this.trackerFaultEndpoint(a), {
          mode: "no-cors",
          __trackjs__: !0
        }))
      },
      sendUsage: function(a) {
        c.isBrowser ? l.createElement("img").src = this.usageEndpoint(a) : fetch(this.usageEndpoint(a), {
          mode: "no-cors",
          __trackjs__: !0
        })
      },
        ...
        if (!this.disabled && !this.throttle(a))
          try {
            if (c.isBrowser) {
              ...
              fetch(this.errorEndpoint(b), f).then(function(a) {
                a.ok || (d.disabled = !0)
              })["catch"](function(a) {
                d.disabled = !0
              })
      ...
      function a(d, e, f, h) {
        ...
        c.forEach(e, function(e) {
          c.forEach(c.keys(e), function(c) {
            null === e[c] || e[c] === n ? d[c] = e[c] : f && 10 > h && "[object Object]" === b(e[c]) ? (d[c] = d[c] || {},
              a(d[c], [e[c]], f, h + 1)) : d.hasOwnProperty(c) || (d[c] = e[c])
          })
        });
        return d
      }
        ...
        afterDocumentLoad: function(a) {
          if (c.isWorker)
            ...
            "complete" === l.readyState ? c.defer(a) : (c.addEventListenerSafe(l, "readystatechange", function() {
              "complete" !== l.readyState || b || (c.defer(a),
                b = !0)
            }),
              setTimeout(function() {
                b || (c.defer(a),
      ...
      pub: function() {
        var a = this
          ...
          watchAll: function(a) {
            ...
            for (f in a)
              "function" !== typeof a[f] || c.contains(b, f) || (a[f] = this.watch(a[f], a));
            return a
          }
        };
